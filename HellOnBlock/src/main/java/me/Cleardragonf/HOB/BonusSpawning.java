...
public class BonusSpawning {
	  ...
	  public void checkEntitySpawn(SpawnEntityEvent event){
			...
			if(ConfigurationManager.getInstance().getConfig().getNode("Spawning Bonuses!", "Ender Dragon", "Enabled").getString().equals("True")){
				...
				ConfigurationManager.getInstance();
				if(ConfigurationManager.getInstance().getConfig().getNode("Spawning Bonuses!", "Ghast", "Enabled").getString().equals("True")){
					...
					ConfigurationManager.getInstance();
					if(ConfigurationManager.getInstance().getConfig().getNode("Spawning Bonuses!", "Giant", "Enabled").getString().equals("True")){
